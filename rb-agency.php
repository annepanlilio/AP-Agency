	...
	function rb_agency_install() {
		...
		if ($wpdb->get_var("show tables like '". table_agency_profile ."'") != table_agency_profile) { // No, it doesn't
			...
			$sql1 = "CREATE TABLE " . table_agency_profile . " (
				...
				ProfileLanguage VARCHAR(255),
				ProfileStatEthnicity VARCHAR(255),
				ProfileStatSkinColor VARCHAR(255),
				ProfileStatHairColor VARCHAR(255),
				ProfileStatEyeColor VARCHAR(255),
				ProfileStatHeight VARCHAR(255),
				ProfileStatWeight VARCHAR(255),
				ProfileStatBust VARCHAR(255),
				ProfileStatWaist VARCHAR(255),
				ProfileStatHip VARCHAR(255),
				ProfileStatShoe VARCHAR(255),
				ProfileStatDress VARCHAR(255),
				ProfileUnion VARCHAR(255),
				ProfileExperience TEXT,
