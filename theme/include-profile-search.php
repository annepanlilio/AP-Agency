   ...
   if ($profilesearch_layout == "condensed" || $profilesearch_layout == "simple") {
	   ...
	   // Advanced
		...
		echo "        		<input type=\"hidden\" name=\"action\" value=\"search\" />\n";
								...
								$query1 = "SELECT ProfileCustomID, ProfileCustomTitle, ProfileCustomType, ProfileCustomOptions FROM ". table_agency_customfields ." WHERE ProfileCustomView = 0 ORDER BY ProfileCustomID DESC";
