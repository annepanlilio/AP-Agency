...
if (isset($_POST['action'])) {
	...
	case 'addRecord':
		if (!empty($SearchTitle)) {
			...
			echo ('<div id="message" class="updated"><p>Search saved successfully! <a href="'. admin_url("admin.php?page=". $_GET['page']) .'&action=editRecord&xSearchID='. $lastid .'">Send Email</a></p></div>'); 
		} else {
