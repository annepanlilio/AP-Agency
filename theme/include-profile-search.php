...
$rb_agency_options_arr = get_option('rb_agency_options');
	...
	if (isset($_REQUEST['ProfileGender']) && !empty($_REQUEST['ProfileGender'])) {  $_SESSION['ProfileGender'] = $_REQUEST['ProfileGender']; }
	   ...
	   // Advanced
		...
		echo "<div class=\"advanced_search_div\"><form action=\"". get_bloginfo("wpurl") ."/search/\" method=\"post\"><input type=\"submit\" name=\"advanced_search\" value=\"". __("Advanced Search", rb_agency_TEXTDOMAIN) . "\" class=\"button-primary\" /></form>";
		}
