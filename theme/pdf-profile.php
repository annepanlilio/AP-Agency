	 ...
	 // $table.=' <div style="page-break-before:always" /></div><br><br><br>';
	  ...
	  $table = str_replace(" />"," /><br>",$table);
		...
		$modelInfo=str_replace("</label>","</label>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$modelInfo);  
			...
			//	$allImages.="<td><img id='".$dataImg["ProfileMediaID"]."' src=\"".get_bloginfo("url")."/wp-content/plugins/rb-agency/timthumb.php?src=". rb_agency_UPLOADDIR . $ProfileGallery ."/". $dataImg['ProfileMediaURL']  .$timthumbHW."\" alt='' class='allimages_thumbs' /></td>\n";

				copy(get_bloginfo("url")."/wp-content/plugins/rb-agency/timthumb.php?src=". rb_agency_UPLOADDIR . $ProfileGallery ."/". $dataImg['ProfileMediaURL']  .$timthumbHW,"/home/content/99/6048999/html/rbplugin.agency/wp-content/plugins/rb-agency/cache/images/".$totalCount.".jpg");
				...
				$allImages.="<td><img $widthAndHeight id='".$dataImg["ProfileMediaID"]."' src='".get_bloginfo("url")."/wp-content/plugins/rb-agency/cache/images/".$totalCount.".jpg' alt='' class='allimages_thumbs' /></td>\n";
					 ...
					 //src=\"".get_bloginfo("url")."/wp-content/plugins/rb-agency/timthumb.php?src=".rb_agency_UPLOADDIR ."". $dataList["ProfileGallery"] ."/". $dataList["ProfileMediaURL"]."&w=200&q=60\"
