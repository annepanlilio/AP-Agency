...
?>
	...
	case "BASIC-LAYOUT":
		...
		echo "				    </div>\n";
		echo "				    <div class=\"search-field single\">\n";
		echo "				       <label for=\"ProfileGender\">". __("Gender", RBAGENCY_TEXTDOMAIN) . "</label>\n";
		...
		echo "				        <legend>". __("Age", RBAGENCY_TEXTDOMAIN) . "</legend>";
		echo "				    <div>";
		echo "				        <label for=\"ProfileDateBirth_min\">". __("Min", RBAGENCY_TEXTDOMAIN) . "</label>";
		...
		echo "				        <div><label for=\"ProfileDateBirth_max\">". __("Max", RBAGENCY_TEXTDOMAIN) . "</label>\n";
		...
		echo "				<input type=\"submit\" value=\"". __("Search Profiles", RBAGENCY_TEXTDOMAIN) . "\" class=\"button-primary\" onclick=\"this.form.action='".get_bloginfo("wpurl")."/profile-search/'\" />";
		echo "				<input type=\"button\" name=\"search\" id=\"rst_btn\" value=\"". __("Empty Form", RBAGENCY_TEXTDOMAIN) . "\" class=\"button-primary\" onclick=\"clearForm();\" />";
 	...
 	* ---------------------------------------------------------------------- */	
  	case "ADVANCE-LAYOUT":
		...
		echo "	 			      <div class=\"search-field single\">\n";
		echo "		 				<label for=\"ProfileCity\">". __("City", RBAGENCY_TEXTDOMAIN) ."</label>\n";
	        echo "		 				<input type=\"text\" id=\"ProfileCity\" name=\"ProfileCity\" value=\"". $_SESSION["ProfileCity"] ."\" />\n";
	        echo "	 				</div>\n";
		echo "	 			      <div class=\"search-field single\">\n";
		echo "		 				<label for=\"ProfileState\">". __("State", RBAGENCY_TEXTDOMAIN) ."</label>\n";
	        echo "		 				<input type=\"text\" id=\"ProfileState\" name=\"ProfileState\" value=\"". $_SESSION["ProfileState"] ."\" />\n";
	        echo "	 				</div>\n";
		echo "	 			      <div class=\"search-field single\">\n";
		echo "		 				<label for=\"ProfileZip\">". __("Zip", RBAGENCY_TEXTDOMAIN) ."</label>\n";
		...
		echo "				<input type=\"submit\" name=\"basic_search\" value=\"". __("Basic Search", RBAGENCY_TEXTDOMAIN) . "\" class=\"button-primary\" onclick=\"this.form.action='".get_bloginfo("wpurl")."/search'\" />";
		echo "				</div>";
 	        echo'				<div></div>';
		echo "        	</form>\n";
	    break;
