...
function rb_display_manage($ProfileID) {
  ...
  echo "  <p><a class=\"button-primary\" href=\"". admin_url("admin.php?page=". $_GET['page']) ."\">". __("Back to ". LabelSingular ." List", rb_agency_TEXTDOMAIN) ."</a></p>\n";
	...
	echo "        <td>\n";
					if ($ProfileGender == "Male") { _e("Chest", rb_agency_TEXTDOMAIN); } elseif ($ProfileGender == "Female"){ _e("Bust", rb_agency_TEXTDOMAIN); } else { echo "". __("Chest", rb_agency_TEXTDOMAIN) ."/". __("Bust", rb_agency_TEXTDOMAIN); } 
