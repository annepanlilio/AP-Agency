...
if($ProfileCustomType!=4)	{
	...
	*/
	...
	elseif ($ProfileCustomType == 7){
		...
		echo "<div class=\"doublebox\"><div><label for=\"ProfileCustomID".$data1['ProfileCustomID']."_min\">Min:</label><input value=\"".(!is_array($min_val) && $min_val != "Array" ? $min_val : "")."\" class=\"stubby\" type=\"text\" name=\"ProfileCustomID".$data1['ProfileCustomID']."[]\" /></div>";
		echo "<div><label for=\"ProfileCustomID".$data1['ProfileCustomID']."_max\">Max:</label><input value=\"".$max_val."\" class=\"stubby\" type=\"text\" name=\"ProfileCustomID".$data1['ProfileCustomID']."[]\" /></div></div>";
	}
